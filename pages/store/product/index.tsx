...
const subCategorySample = {	content :[
...
function Product(){
    ...
    const [subCategory ,setSubCategory]  = useState(subCategorySample.content[0].value);
    const [cycle, setCycle] = useState('');
    const [deliveryDate, setDeliveryDate] = useState('');
    const [options, setOptions] = useState([]);
    const [maxCount, maxConut] = useState(0);
    const [thumbNails, setTuhmbNails] = useState([]);
                ...
                return  <Title title={title} setTitle={setTitle} 
                                category={category} setCategory={setCategory}
                                 subCategory={subCategory} setSubcategory={setSubCategory}
                                  categories = {categorySample} subCategories ={subCategorySample}/>;
            case 1:
                return <Options cycle = {cycle}
                setCycle = {setCycle}
                ...
                maxConut = {maxConut}/>;
            case 2:
                return  <Thumbnail thumbNails = {thumbNails}
                setTuhmbNails = {setTuhmbNails}/>;
            
            case 3:
                return  <ServiceImage services = {services}
                setServices = {setServices}/>;
            case 4:
                return <Detail deliveryOption = {deliveryOption}
