...
import { udpatePasswordInfo, updateMyInfo } from "../../src/lib/api/mypage";
...
function Info({ data }: any) {
    ...
    const [updateInfo, setUpdateInfo] = useState({
        ...
        phone1: data.data.phone.phoneNumber ? data.data.phone.phoneNumber.substring(0, 3) : null,
        phone2: data.data.phone.phoneNumber ? data.data.phone.phoneNumber.substring(3, 7) : null,
        phone3: data.data.phone.phoneNumber ? data.data.phone.phoneNumber.substring(7, 11) : null,
    });
        ...
        <div style={{ marginTop: '1%' }}>
            <table>
                ...
                <tbody>
                    <tr>
                        <th>이름</th>
                        <td><TextField disabled name='name' value={data.data.name} /></td>
                    </tr>
                    <tr>
                        <th>아이디(이메일)</th>
                        <td><TextField disabled name='email' value={data.data.email} /></td>
                    </tr>
                    <tr>
                        <th>연락처</th>
                        <td>
